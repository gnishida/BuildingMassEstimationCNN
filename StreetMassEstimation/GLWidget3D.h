...
public:
	...
	void render(int grammarSnippetId, bool centering3D, float cameraDistanceBase, int xrotMin, int xrotMax, int yrotMin, int yrotMax, int zrotMin, int zrotMax, int fovMin, int fovMax, int xMin, int xMax, int yMin, int yMax, const std::vector<float>& params, std::vector<boost::shared_ptr<glutils::Face>>& faces, cv::Mat& renderedImage);
	void setupCameraFromParams(int xrotMin, int xrotMax, int yrotMin, int yrotMax, int zrotMin, int zrotMax, int fovMin, int fovMax, int xMin, int xMax, int yMin, int yMax, float cameraDistanceBase, const std::vector<float>& params);
