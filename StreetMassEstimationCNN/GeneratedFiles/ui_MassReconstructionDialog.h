...
public:
    ...
    void setupUi(QDialog *MassReconstructionDialog)
    {
        ...
        label_17 = new QLabel(MassReconstructionDialog);
        ...
        lineEditMaxNoise = new QLineEdit(MassReconstructionDialog);
        ...
        label_19 = new QLabel(MassReconstructionDialog);
        ...
        lineEditNumMultipleTries = new QLineEdit(MassReconstructionDialog);
        ...
        checkBoxTryMultiples = new QCheckBox(MassReconstructionDialog);
        ...
        label_18 = new QLabel(MassReconstructionDialog);
        ...
        QWidget::setTabOrder(lineEditImageBlurSize, checkBoxTryMultiples);
    ...
    void retranslateUi(QDialog *MassReconstructionDialog)
    {
        ...
        label_17->setText(QApplication::translate("MassReconstructionDialog", "# Tries:", 0));
        label_19->setText(QApplication::translate("MassReconstructionDialog", "%", 0));
        ...
        checkBoxTryMultiples->setText(QApplication::translate("MassReconstructionDialog", "Try Multiples", 0));
        ...
        label_18->setText(QApplication::translate("MassReconstructionDialog", "Max Noise:", 0));
